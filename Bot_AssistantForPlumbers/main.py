        ...
        if message.text == "📸 Отчет":
            ...
            while count <= 5:
                if count == 3 or count == 4:
                    photo = open('examples/Primer' + str(count) + '.jpg', 'rb')
                    bot.send_photo(message.chat.id, photo)
                    photo = open('examples/Primer' + str(count) + '.1.jpg', 'rb')
                    bot.send_photo(message.chat.id, photo)
                else:
                    photo = open('examples/Primer' + str(count) + '.jpg', 'rb')
                    bot.send_photo(message.chat.id, photo)
                text = open('examples/Primer' + str(count) + '.txt', 'r', encoding='utf-8')
                text = text.read()
            ...
            bot.delete_message(message.chat.id, message.message_id - 1)
            bot.delete_message(message.chat.id, message.message_id)
            with open('examples/Rules.txt', 'r', encoding='utf8') as new_file:
                rule = new_file.read()
